...
#     expect_snapshot_file("inst/app/www/assets/markdown/03_gender_pay_gap_1.md")
#     expect_snapshot_file("inst/app/www/assets/markdown/03_gender_pay_gap_2.md")
#     expect_snapshot_file("inst/app/www/assets/markdown/04_quartile.md")
#     expect_snapshot_file("inst/app/www/assets/markdown/05_action.md")
#   })
# })
