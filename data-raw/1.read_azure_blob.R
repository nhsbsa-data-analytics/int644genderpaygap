# # 20/29/2024: Data needs to download from ESR BI tool. (National Returns Dashboard)
# # This script doesn't work as you can't delete azure blob storage
# # Copy paste from `GPG` folder which will hold all historical files
# # If you rerun it later year, figures could change - it is important to keep historical data.
# 
# library(AzureStor)
# library(jsonlite)
# library(janitor)
